...
public class FileUtil {
    ...
    public static final String[] IMG_FILE = {"bmp", "jpg", "png", "tif", "gif", "jpeg", "svg"};
    public static final String[] DOC_FILE = {"doc", "docx", "txt", "hlp", "wps", "rtf", "html", "pdf","ppt", "pptx", "xls", "xlsx"};
