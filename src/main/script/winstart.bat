...
java -version
java  %JAVA_VM% %JAVA_OPTIONS% -classpath %CLASSPATH% -Xdebug  -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=8336 com.qiwenshare.stock.StockApplication
