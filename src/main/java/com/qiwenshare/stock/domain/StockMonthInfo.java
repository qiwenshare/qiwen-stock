...
public class StockMonthInfo {
    ...
    public StockMonthInfo() {
        super();
    }

    public StockMonthInfo(String stockcode, Date date, double open, double high, double low, double close,
    ...
    public String getMonthinfoid() {
        return monthinfoid;
    }

    public void setMonthinfoid(String monthinfoid) {
        this.monthinfoid = monthinfoid;
    }
